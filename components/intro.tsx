...
import PeejSwimHeadshot from '@/public/PeejSwimHeadshot.jpg'
  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
        ...
        >
            ...
            <span className="font-bold">computer science student (Class of 2025)</span> at{" "}
            <span className="font-bold">SUNY Fredonia</span>. I enjoy
            building <span className="italic">all types of applications</span>. My focuses are{" "}
            <span className="underline">Python, C# (.NET), and Web Development</span>.
        </motion.p>
        ...
        >
            ...
            href="https://www.linkedin.com/in/patrick-mccrone-77b92028b/"
            target="_blank"
            >
                <BsLinkedin />
            </a>
            ...
            border border-black/10"
            href="https://github.com/PatrickMcCrone/"
            target="_blank"
            >
                <FaGithubSquare />
            </a>
